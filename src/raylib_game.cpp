...
int main(void)
{
    ...
    Entity exampleWall = Entity(Vector2{400.0f, 200.0f}, 0.0f, 0,  new GraphicsComponent(wallTexture, 25.0f), new PhysicsComponent(sampleScene.physicsHandler, Shape(Shape::ShapeType::Rectangle, Shape::ShapeData{ 50.0f })));
