...
int main(void)
{
    ...
    Entity exampleEntity = Entity(Vector2{ 100.0f, 100.0f }, 0, new GraphicsComponent(), new PhysicsComponent(sampleScene.physicsHandler, Shape(), 1, Vector2{ 200.0f, 300.0f }));
