...
int main(void)
{
    ...
    Entity exampleEntity = Entity(Vector2{ 100.0f, 100.0f }, new GraphicsComponent(), new PhysicsComponent(sampleScene.physicsHandler, Shape(), 1, Vector2{ 50.0f, 50.0f }));
    Entity exampleEntity2 = Entity(Vector2{ 900.0f, 100.0f }, new GraphicsComponent(), new PhysicsComponent(sampleScene.physicsHandler, Shape(), 1, Vector2{ -50.0f, 50.0f }));
