...
int main(void)
{
    ...
    Shape::ShapeData wallShape;
    wallShape.rectangleData = Shape::RectangleDimensions{ 50.0f, 50.0f };
    Entity exampleWall = Entity(Vector2{400.0f, 200.0f}, PI / 4, 0,  new GraphicsComponent(wallTexture, 25.0f), new PhysicsComponent(sampleScene.physicsHandler, Shape(Shape::ShapeType::Rectangle, wallShape)));
